...
class User:
    ...
    def __init__(self, username: str, email: str, password: str, role: str = 'user', 
        ...
        self.password = password  # NO hashear aquí - guardar como está
        self.role = role
    ...
    def from_dict(cls, data: dict):
        ...
        # La contraseña ya viene hasheada de BD, no hacer nada más
    ...
    def update_in_db(self, data: dict):
        ...
        # Hashear contraseña si se proporciona (pero esto NO debería suceder aquí)
